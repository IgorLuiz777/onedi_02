...
// Função para inserir ou atualizar usuário no banco
...
// Função para consultar usuário no banco pelo telefone
...
// Função para salvar progresso de lição
...
// Função para adicionar palavra ao vocabulário do usuário
...
// Função para buscar palavras para revisão
...
// Função para registrar sessão de estudo
